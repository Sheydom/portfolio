    ...
    >
        ...
        <div class="flex flex-col gap-2">
            ...
            <textarea
                ...
                class="min-h-[180px] resize-none rounded-lg border border-primary/30 bg-background px-4 py-3 text-white outline-none transition placeholder:text-neutral focus:border-primary focus:shadow-[0_0_20px_-12px] focus:shadow-primary"
            ></textarea>
