<aside
    ...
    <div class="">
        ...
        <ul class="flex flex-col gap-5">
            <li>
                <a href=""
                    class="  px-5 py-2.5 flex gap-2 items-center hover:bg-primary/80 hover:text-black transition duration-300 ease-in-out "><svg
                        class="w-7 h-7 shrink-0 text-secondary   transition duration-300 ease-in-out" viewBox="0 0 24 24"
            ...
            <li>
                <a href=""
                    class="px-5   py-2.5 flex gap-2 items-center hover:bg-primary/80 hover:text-black transition duration-300 ease-in-out cursor-pointer"><svg
                        class="shrink-0 w-7 h-7 items-center text-secondary transition duration-300 ease-in-out"
            ...
            <li>
                <a href=""
                    class="px-5   py-2.5 flex gap-2 items-center hover:bg-primary/80 hover:text-black transition duration-300 ease-in-out cursor-pointer">
                    <svg class="w-7 h-7 shrink-0 text-secondary transition duration-300 ease-in-out" viewBox="0 0 24 24"
                        fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                        <g id="SVGRepo_iconCarrier">
            ...
            <li>
                <a href=""
                    class="px-5  py-2.5 flex items-center gap-2 hover:bg-primary/80 hover:text-black transition duration-300 ease-in-out cursor-pointer">
                    <svg class="w-7 h-7 shrink-0 text-secondary  transition duration-300 ease-in-out"
                        ...
                        <g id="SVGRepo_iconCarrier">
                            ...
                            <path d="M12 17V14" stroke="currentColor"  stroke-width="1" stroke-linecap="round"></path>
